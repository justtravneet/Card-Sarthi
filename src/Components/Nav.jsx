...
const Nav = () => {
  return (
    <div className='px-[12px] 2xl:justify-center '>
         <div className='flex  items-center  lg:justify-center justify-between xl:justify-center lg:gap-[200px] xl:gap-[250px] 2xl:gap-[300px] 2xl:justify-center'>
                  <div>
                  ...
                  <div className=' search md:hidden icons flex gap-2 '>
                         <Search size={28} />
                         <Bell size={28} />
